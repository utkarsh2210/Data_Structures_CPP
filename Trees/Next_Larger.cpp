...
TreeNode<int>* getNextLargerElement(TreeNode<int>* root, int x) {
    ...
    {
        TreeNode<int>* secondAns = getNextLargerElement(root->children[i], x);
        if(ans!=NULL && secondAns!=NULL)
        {
            if(secondAns->data > x && secondAns->data < ans->data)
            {
                ans = secondAns;
            }
        }
        else if(ans==NULL && secondAns!=NULL)
        {
            if(secondAns->data > x)
            {
                ans = secondAns;
